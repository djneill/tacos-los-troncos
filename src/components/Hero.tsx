    ...
    <section id="home" className="relative h-[600px] md:h-[700px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        <button
          ...
          className="bg-orange-700 hover:bg-orange-800 text-white font-bold px-10 py-4 rounded-lg text-lg transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105"
        >
          View The Menu
        </button>
      </div>
